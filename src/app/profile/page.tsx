      ...
      {userId ? (
        <form className="mt-6 grid gap-4 rounded-md border border-black/10 bg-white p-6 shadow-soft" onSubmit={saveProfile}>
          <label>
            ...
            <input className="mt-2 w-full rounded-md border border-black/15 px-3 py-2" value={profile.display_name} onChange={(event) => setProfile({ ...profile, display_name: event.target.value })} required maxLength={80} minLength={2} />
          </label>
          <div className="grid gap-4 sm:grid-cols-2">
            <label>
              <span className="text-sm font-semibold">City</span>
              <input className="mt-2 w-full rounded-md border border-black/15 px-3 py-2" value={profile.city} onChange={(event) => setProfile({ ...profile, city: event.target.value })} maxLength={100} />
            </label>
            <label>
          ...
          <label>
            ...
            <textarea className="mt-2 min-h-28 w-full rounded-md border border-black/15 px-3 py-2" value={profile.bio} onChange={(event) => setProfile({ ...profile, bio: event.target.value })} maxLength={500} />
          </label>
          <label>
